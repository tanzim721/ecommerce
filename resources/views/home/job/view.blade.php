                    ...
                    <div class="max-w-2xl mx-auto text-center">
                        ...
                        <form class="mt-10">
                            <div class="relative w-full">
                                ...
                                <input type="search" placeholder="e.g. FullStack Laravel & VueJS Developer" name="search"
            ...
            <div class="grid grid-cols-12 lg:gap-12">
                <div class="col-span-12" id="find-job">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="text-base text-white/60"> {{ count($jobs) }} {{ str('Result')->plural($jobs->count()) }}
                            Found</p>
                    </div>
                    <!-- /Section Header -->
                    <!-- Job Listings -->
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex flex-col items-start gap-6 md:flex-row md:items-center">
                                        <img alt="company logo" loading="lazy" class="w-16 h-16 p-2 bg-gray-700 rounded-xl"
                                            style="color: transparent" src="{{ $job->company_logo }}" />
                                        <div>
                                            ...
                                            <h6
                                                ...
                                                <a
                                                    href="{{ route('career.job_details', $job->id) }}">{{ $job->title }}</a>
                                            </h6>
                                            <div class="flex items-center gap-2 mt-3">
                                                ...
                                                <p class="px-2 py-1 text-xs rounded-md bg-gray-300/30 w-fit text-white/70">
                                                    {{ \Carbon\Carbon::parse($job->created_at)->diffForHumans(null, true, true, 2) }}
                                                    hours ago
                                                </p>
                                            </div>
                                        </div>
